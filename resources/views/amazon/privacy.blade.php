	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<p>This Privacy Policy governs the manner in which The Destroyer&#039;s Den LARP collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="http://destroyersden.com">http://destroyersden.com</a> website ("Site").</p>
				...
				<p>The Destroyer&#039;s Den LARP may collect and use Users personal information for the following purposes:</p>
				<ul>
				  <li>
