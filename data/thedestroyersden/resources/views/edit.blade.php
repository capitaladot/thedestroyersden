	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">{{studly_case($modelName)}}: {{ ($model->getAttribute('title') ? $model->getAttribute('title') : '#'.$model->id) }}</div>
				<div class="panel-body">
					...
					@endif
					{!! Form::model($model,['route' => [strtolower($modelName).'.update', $model->id], 'method' => 'PUT']) !!}
					<ul>
						...
						@else
							{!! Form::input($properties['inputType'],$input, $model->getAttribute($properties['columnName']),[
