...
class MainMenuRepository implements CriteriaContract{
	protected $app;
	...
	public function all($columns = array('*')) {
		$this->applyCriteria ();
		if(is_array( $this->model->newQuery ( $columns )))
			return $this->model->newQuery ( $columns )->eagerLoadRelations ( $this->model->relatedModels )->model->get($columns);
