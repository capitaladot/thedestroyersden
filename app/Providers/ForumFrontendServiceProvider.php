...
use Riari\Forum\Frontend\ForumFrontendServiceProvider as FFSP;

class ForumFrontendServiceProvider extends FFSP
{
    /**
    ...
    {
        $this->baseDir = base_path().'/vendor/riari/laravel-forum-frontend/';
    ...
    public function registerAliases()
    {
        ...
        $loader->alias('Category', 'App\Category');
        $loader->alias('Post', 'App\Post');
        $loader->alias('Thread', 'App\Thread');
    }
